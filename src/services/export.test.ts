...
describe("exportDailyReport", () => {
  ...
  it("应该包含概览统计", () => {
    const result = exportDailyReport(
      "2026-05-03",
      mockTasks,
      mockReflections,
      mockSessions
...
describe("exportAdvancedReport", () => {
  ...
  it("task + csv 应正确转义含逗号内容", () => {
    const tasks = [{ ...mockTasks[0], title: "报告,含逗号" }];
    const result = exportAdvancedReport({
      type: "task",
      format: "csv",
      tasks,
